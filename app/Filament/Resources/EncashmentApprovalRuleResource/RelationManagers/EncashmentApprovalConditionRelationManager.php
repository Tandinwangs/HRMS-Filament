...
namespace App\Filament\Resources\EncashmentApprovalRuleResource\RelationManagers;
...
class EncashmentApprovalConditionRelationManager extends RelationManager
{
    protected static string $relationship = 'encashmentApprovalCondition';

    protected static ?string $recordTitleAttribute = 'encashment condition';
