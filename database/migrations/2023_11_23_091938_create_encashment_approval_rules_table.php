...
return new class extends Migration
{
    ...
    {
        Schema::create('encashment_approval_rules', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->string('For');
            $table->string('RuleName');
            $table->uuid('type_id');
            $table->foreign("type_id")->references("id")->on("encashments")->onDelete('RESTRICT')->onUpdate('CASCADE');
    ...
    {
        Schema::dropIfExists('encashment_approval_rules');
    }
};
